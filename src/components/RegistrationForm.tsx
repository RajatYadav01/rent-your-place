...
const passwordVisibilityStatusReducer = (
  state: RegistrationFormPasswordVisibilityStatusType,
  action: RegistrationFormPasswordVisibilityActionType
) => {
  switch (action.name) {
    case "password":
      return {
...
function RegistrationForm() {
  ...
  const [passwordVisibilityStatus, dispatchPasswordVisibilityStatus] =
    useReducer(
      ...
      registrationFormPasswordVisibilityStatusInitialState
    );
  ...
  const registrationSuccessStatusContext = useContext(
    RegistrationSuccessStatusContext
  );
    ...
    if (
      ...
      try {
        ...
        const isRegistrationSuccessful =
          serverResponse.data.status === "Registration successful"
            ? true
            : false;
        registrationSuccessStatusContext.setRegistrationSuccessState(
    ...
    <Fragment>
      {errorMessage.registrationError && (
        <p
          ...
          className="registration-form__show-error"
          aria-live="assertive"
        >
          {errorMessage.registrationError}
        </p>
      ...
      >
        <div className="registration-form__label-group">
          <label
            ...
            htmlFor="registration-form__user-type"
          >
            Choose user type:{" "}
          </label>
          <select
            id="registration-form__user-type"
            className={`registration-form__user-type ${
              registrationFormState.userType !== ""
                ? userTypeInputStatus.valid
                  ? "valid-input"
                  : "invalid-input"
        ...
        {registrationFormState.userType &&
          ...
          !userTypeInputStatus.valid && (
            <p
              id="registration-form__user-type-requirements"
              className="registration-form__show-instructions"
            >
        ...
        <div className="registration-form__name-group">
          <div className="registration-form__name-floating-label-group">
            ...
            <label
              lang="en"
              className="registration-form__name-floating-label"
              htmlFor="registration-form__first-name"
            >
          ...
          <div className="registration-form__name-floating-label-group">
            ...
            <label
              lang="en"
              className="registration-form__name-floating-label"
              htmlFor="registration-form__last-name"
            >
        ...
        {registrationFormState.firstName &&
          ...
          !firstNameInputStatus.valid && (
            <p
              id="registration-form__first-name-requirements"
              className="registration-form__show-instructions"
            >
        ...
        {registrationFormState.lastName &&
          ...
          !lastNameInputStatus.valid && (
            <p
              id="registration-form__last-name-requirements"
              className="registration-form__show-instructions"
            >
        ...
        <div className="registration-form__floating-label-group">
          <input
            ...
            className={`registration-form__email-address ${
              registrationFormState.emailAddress !== ""
                ? emailAddressInputStatus.valid
                  ? "valid-input"
                  : "invalid-input"
          ...
          <label
            lang="en"
            className="registration-form__floating-label"
        ...
        <div className="registration-form__floating-label-group">
          ...
          <label
            lang="en"
            className="registration-form__floating-label"
            htmlFor="registration-form__phone-number"
          >
        ...
        {registrationFormState.phoneNumber &&
          ...
          !phoneNumberInputStatus.valid && (
            <p
              id="registration-form__phone-number-requirements"
              className="registration-form__show-instructions"
            >
        ...
        <div className="registration-form__floating-label-group">
          ...
          <span className="registration-form__password-visibility-icon">
            <i
        ...
        <div className="registration-form__floating-label-group">
          <input
            ...
            className={`registration-form__confirm-password ${
              registrationFormState.confirmPassword !== ""
                ? confirmPasswordInputStatus.valid
                  ? "valid-input"
                  : "invalid-input"
        ...
        <button
          className={`registration-form__button--register ${
            isRegisterButtonDisabled ? "button-disabled" : ""
          }`}
          lang="en"
          name="register"
          type="submit"
          disabled={isRegisterButtonDisabled ? true : false}
        >
          <i></i>REGISTER
        </button>
      </form>
