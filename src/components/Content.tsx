...
function Content(props: ContentFormProps) {
    ...
    if (props.loginFormDisplayToggleValue || props.registrationFormDisplayToggleValue || props.resetPasswordFormDisplayToggleValue) {
    ...
    return (
        <div className="content">
            ...
            {!loginStatusState.loggedIn ? (displayFormElement && 
                <Fragment>
                    <Form loginFormDisplayToggleValue={props.loginFormDisplayToggleValue} registrationFormDisplayToggleValue={props.registrationFormDisplayToggleValue} resetPasswordFormDisplayToggleValue={props.resetPasswordFormDisplayToggleValue}/>
                </Fragment>) : ""}
            <Properties userID={""} newPropertyAdded={null} propertyUpdated={null} setPropertyFormInitialValues={null}/>
        </div>
    );
}
